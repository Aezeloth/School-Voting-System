...
<div class="wrapper">
    ...
    <div class="content-wrapper" 
         style="background-color: white; background-image: url('/images/bgvoting.jpg'); 
                        ...
                        if ($vquery->num_rows > 0) {
                            echo "
                                <div class='text-center' style='color:black;font-size: 35px; font-family: Times;'>
                                    <h3 style:'color:black;'>You have already voted for this election.</h3>
                                    <a href='#view' data-toggle='modal' class='btn btn-curve btn-primary btn-lg' 
                                       style='background-color: #4682B4; color:black; font-size: 22px; font-family: Times'>
                                        View Ballot
                                    </a>
                                </div>";
                        } else {
                            ...
                            <form method="POST" id="ballotForm" action="submit_ballot.php">
                                ...
                                while ($row = $query->fetch_assoc()) {
                                    ...
                                    while ($crow = $cquery->fetch_assoc()) {
                                        ...
                                        $candidate .= "
                                            <li>
                                                $input
                                                <button type='button' class='btn btn-primary btn-sm btn-curve clist platform' 
                                    ...
                                    echo "
                                        <div class='row'>
                                            <div class='col-xs-12'>
                                                <div class='box box-solid ballot-glass' id='" . $row['id'] . "'>
                                                    ...
                                                    <div class='box-body'>
                                                        <p>$instruct
                                                            <span class='pull-right'>
                                                                <button type='button' class='btn btn-success btn-sm btn-curve reset' 
                                ...
                                <div class="text-center">
                                    <button type="button" class="btn btn-success btn-curve" 
                                            style="background-color: #9CD095; color:black; font-size: 16px; font-family: Times; padding:7px 30px; margin:10px;" 
                                            id="preview">
                                        <i class="fa fa-file-text"></i> Preview
                                    </button>
                                    <button type="submit" class="btn btn-primary btn-curve" 
                                            style="background-color: #4682B4; color:white; font-size: 16px; font-family: Times; padding:7px 30px; margin:10px;" 
                                            name="vote">
...
<style>
/* Glass Effect for Voting Ballot */
.ballot-glass {
...
input[type="radio"] {
    accent-color: #2692ff; /* Radio button color */
}
.box-title{
	color:white;
}
