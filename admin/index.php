...
<div class="login-box glass-effect" 
    ...
    <div class="login-logo" 
        ...
        <br>
        <b>ACLC Online<br>Voting Admin Panel</b>
    </div>
    ...
    <div class="login-box-body glass-effect" 
        ...
        <p class="login-box-msg" 
           style="color: white; font-size: 16px; font-family: system-ui;">
            Sign in to start your admin session
        </p>
...
.glass-effect {
    ...
    border: 1px solid rgb(255, 38, 38);                    /* Border */
...
<script>
// Toggles password visibility (if needed in the future)
