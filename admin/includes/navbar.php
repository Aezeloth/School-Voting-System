<header class="main-header" style="background-color:#0c1d88 " >
  <!-- Logo -->
  <a href="#" class="logo " style="background-color: #0c1d88">
    <!-- mini logo for sidebar mini 50x50 pixels -->
    <span class="logo-mini" style="background-color: #0c1d88 "><b>O</b>VS</span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg " style="background-color:#0c1d88 ;color:white ; font-size: 22px; font-family:Times  "><marquee behavior="scroll" direction="left">Online Voting System</marquee></span>
  ...
  <nav class="navbar navbar-static-top " style="background-color: #0c1d88 ">
    ...
    <div class="navbar-custom-menu" style="color:black ; font-size: 17px; font-family:Times">
      <ul class="nav navbar-nav" style="background-color: #0c1d88 ;color:black ; font-size: 17px; font-family:Times" >
        <!-- User Account: style can be found in dropdown.less -->
        <li class="dropdown user user-menu  " style="color:black">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="background-color: #0c1d88 ;color:white ; font-size: 17px; font-family:Times" >
