...
<div class="modal fade" id="preview_modal">
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: white; color: black; font-size: 15px; font-family: Times;">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-curve pull-left" 
                        style="background-color: white; color: black; font-size: 12px; font-family: Times;" 
                        data-dismiss="modal">
        ...
        <div class="modal-content" style="background-color: white; color: black; font-size: 15px; font-family: Times;">
            ...
            <div class="modal-body">
                ...
                while ($row = $query->fetch_assoc()) {
                    echo "
                        <div class='row votelist' style='border: 1px solid #1A0076; padding: 10px; margin-bottom: 5px;'>
                            <span class='col-sm-4'>
                                <span class='pull-right'><b>" . $row['description'] . ":</b></span>
                            </span>
